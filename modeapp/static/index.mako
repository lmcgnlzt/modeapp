...
<!-- <link href="styles/jquery.lazyloadxt.fadein.css"   rel="stylesheet" type="text/css"> -->
...
<!-- <script type="text/javascript" src="scripts/jquery.lazyloadxt.extra.js"></script> -->
...
<!-- <script type="text/javascript" src="scripts/jquery.shorten.min.js"></script> -->
...
<div class="all-elements">
    <div class="snap-drawers">
        ...
        <div class="snap-drawer snap-drawer-left">
            <a href="/collections"><i class="fa fa-home"></i>主页</a>
            ...
            <a href="#"><i class="fa fa-facebook"></i>关于我们</a>
    ...
    <!-- <div class="header">
        ...
        <a href="page-media.html" class="open-back"><i class="fa fa-chevron-left"></i></a>
    </div> -->
    ...
    <div id="content" class="snap-content">
        <div class="slider-container full-bottom">
            <div class="homepage-slider" data-snap-ignore="true">
                <div>
                    ...
                    <img src="images/index/header1.jpg" class="responsive-image" alt="img">
                </div>
                <div>
                    <div class="overlay"></div>
                    ...
                    <img src="images/index/header4.jpg" class="responsive-image" alt="img">
                </div>
                <div>
                    <div class="overlay"></div>
                    ...
                    <img src="images/index/header3.jpg" class="responsive-image" alt="img">
                </div>
            </div>
        </div>
        ...
        <div class="content">
            ...
            <!-- <img src="images/home/home_background.png" alt="img" class="responsive-image"> -->
            ...
            <div>
                ...
                <div class="row">
                    <div class="shopbox">
                        <a href="#">
                            <img src="images/index/garment2.jpg" alt="" />
                            <h3>产品</h3>
                        </a>
                    </div>
                    <div class="shopbox">
                        <a href="#">
                        <img src="images/index/designer.jpg" alt="" />
                        <h3>设计师</h3>
                        </a>
                    </div>
                    <div class="shopbox">
                        <a href="#">
                        <img src="images/index/book.jpg" alt="" />
                        <h3>FASHION BOOK</h3>
                        </a>
                    </div>
                    <div class="shopbox">
                        <a href="#">
                        <img src="images/index/music2.png" alt="" />
                        <h3>3D 音乐</h3>
                        </a>
                    </div>
                </div>
