    ...
    e.prototype.init = function() {
        ...
        if (!l.$slide.eq(c).hasClass("lg-loaded")) {
            if (q) {
                ...
                l.$slide.eq(c).prepend('<div class="lg-iframe-cont" style="max-width:' + l.s.iframeMaxWidth + '"><div class="lg-iframe"><iframe class="lg-object" frameborder="0" src="' + g + '"  allowfullscreen="true"></iframe></div></div>');
            }
            else if (m) {
                var s = "";
