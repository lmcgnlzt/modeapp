...
$(document).ready(function() {
 ...
 //    //HOMESCREEN
	...
	// // $(".homescreen-gallery a, .homescreen-show-gallery").swipebox();
	// $(".homescreen-show-gallery").swipebox();
 ...
 //    });
   ...
   //  var modeflip_api = "http://127.0.0.1:6543/designers";
   //  $("#designer_page").ready(function(){
   ...
   //  })
	...
	var owlProductControls = $(".product-slider");
	owlProductControls.owlCarousel({
		//Basic Stuff
		items : 3,
		itemsDesktop : [1199,3],
		itemsDesktopSmall : [980,3],
	...
	$(".next-product").click(function(){
	  owlProductControls.trigger('owl.next');
	  return false;
	});
	$(".prev-product").click(function(){
	  owlProductControls.trigger('owl.prev');
	  return false;
	});
