...
$(document).ready(function() {
    ...
    $('#head-slider').slick({slidesToShow: 1});
    $('#upper-slider').slick({slidesToShow: 1});
    $('#lower-slider').slick({slidesToShow: 1});
    $('#foot-slider').slick({slidesToShow: 1});
    ...
    var endDate = "July 20, 2016 12:00:00";
